Create one horizontal four-cardinal anchor strip for Codex pet `xiaodi`.
...
Place one pose in each invisible equal-width slot on a flat pure green #00FF00 background with generous padding. Keep scale, feet/base, lower body, and registration consistent across all four slots. Keep each full-body girl compact and centered with wide empty green gutters on both sides; no long hair strand, hand, boot, shark fin, skirt, or tail cape may approach or cross an invisible quarter boundary.
