Create one horizontal look-direction strip for Codex pet `xiaodi`, atlas row 10.
...
MANDATORY CONTINUITY REPAIR: the previous row passed left/right semantics but failed the visible `337.5 -> 000` loop boundary because 337.5 kept both arms down while 000 suddenly raised both arms and lifted the hair/cape. Preserve the correct left-facing family, but gradually introduce the approved 000 upward-drag body action across the last three slots: at 292.5 the hands/forearms begin to lift and hair rises slightly; at 315 they lift more; at 337.5 both hands are almost as high as 000, chin and upper body are nearly lifted to the 000 pose, and hair/tail cape are one small step below the approved 000 lift. The 337.5 center, body height, silhouette area and registration must be close to 000 so the wrap has no arm snap, scale jump or center jump. Keep a subtle screen-left nose/iris cue at 337.5.
