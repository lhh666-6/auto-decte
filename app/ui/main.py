...
from app.ui.pages import ai_vector, exceptions, export_page, import_page, review, search
...
import_tab, review_tab, rules_tab, search_tab, ai_tab, export_tab = st.tabs(
    ["批量导入", "人工复核", "规则异常", "查询追溯", "AI 与相似检索", "XLSX 导出"]
)
with import_tab:
